		    	...
		    	<c:if test="${comListCount!=0}">
					...
					<c:forEach var="comment" items="${comList}" varStatus="status">
					    <ul class="comment-list">
							<li class="comment">
								<div class="vcard bio">
                    				<h5 style="color:#82ae46;">${comment.BC_ID }</h5>
                  				</div>
   ...
   <div style="display:inline-block; float:right; width:10%;">
	...
	<hr>
	  <div align="center" style="height:100px;"> 
		...
		<input type="button" value="수정" class="btn btn-primary py-2 px-2" style="height:55px;" onClick="location.href='adminBoardModifyForm.omc?BD_NUM=${boardDetail.BD_NUM}'">
...
function deleteCheck() {
	...
	if(confirm("삭제하시겠습니까?") == true) {
		location.href="adminBoardDelete.omc?BD_NUM=" + BD_NUM;
	}
}
</script>
