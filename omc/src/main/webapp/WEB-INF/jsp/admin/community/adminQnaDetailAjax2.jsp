							...
							<li class="comment" id="Dcom${status.index}">
								...
								<div class="comment-body">
									...
									<p style="font-size:middle; width: 100%;">
									 ...
									 <div>
									 <a onClick="modifyCheckAjax(${comment.BC_BCID }, ${qnaMap.BD_NUM} ,${status.index});" class="reply">수정</a>
			...
			<form action="adminQnaComWrite.omc?BD_NUM=${qnaMap.BD_NUM}" method="post" ><hr>
				...
				<input class="form-control input-sm" id="newReplyWriter" 
					...
					<div class="row">
						...
						<div class="form-group">
							<input type="button" class="btn py-3 px-4 btn-primary btn-outline-primary" onClick="WriteCheckAjax(${qnaMap.BD_NUM});" value="등록">
					 	</div>
