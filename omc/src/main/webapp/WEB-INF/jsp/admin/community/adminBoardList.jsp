...
<br>
    ...
    <c:choose> 
    	...
    	<tr> 
    		<td>${board.BD_NUM }</td> 
    		<td> 
    			<a href="adminBoardDetail.omc?BD_NUM=${board.BD_NUM}">${board.BD_TITLE}</a>
   			</td>
   			<td>${board.BD_ID}</td> 
   			<td ${board.BD_REGDATE}>
   			...
   			<td>
   				<a href="adminBoardModifyForm.omc?BD_NUM=${board.BD_NUM}">수정</a>/
   				<a href="adminBoardDelete.omc?BD_NUM=${board.BD_NUM}">삭제</a>
   			</td>
    	</tr> 
			</c:forEach>
    </c:when>
