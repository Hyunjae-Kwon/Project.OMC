							...
							<table class="table">
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="text" maxlength="50" id="GD_GNAME" name="GD_GNAME" class="form-control">
										</td>
									</tr>
									<tr>
										<td>
									...
									<!-- <tr>
										...
										<td>
											<img src="resources/img/omc_logoIcon.png" width="300" border="0"
												id="preview-image">
											<script>
									...
									<tr>
										...
										<td>
											<!-- 숫자 이외의 문자가 오면 자동으로 삭제됨 -->
											<input type="number" maxlength="20" id="GD_STOCK" name="GD_STOCK" class="form-control"
									...
									<tr>
										...
										<td>
											<!-- 숫자 이외의 문자가 오면 자동으로 삭제됨 -->
											<input type="number" maxlength="20" id="GD_PRICE" name="GD_PRICE" class="form-control"
												onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
										</td>
									</tr>
									<tr>
										<td>
											<b><label for="GD_DCPRICE">할인 가격</label></b>
										</td>
										<td>
