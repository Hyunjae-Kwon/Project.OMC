							...
							<div class="join_base_wrap">
								...
								<div class="member_cont">
									<form id="formJoin" name="formJoin"
										action="https://www.mychef.kr/member/member_ps.php"
										method="post" novalidate="novalidate">
										<input type="hidden" name="rncheck" value="authCellphone">
										<input type="hidden" name="dupeinfo"
											value="MC0GCCqGSIb3DQIJAyEAQaDjsABuABUXWVB+FOsB9+xVF+OyY7WTyS8yiobtAOo=">
										<input type="hidden" name="pakey" value=""> <input
											type="hidden" name="foreigner" value="0"> <input
											type="hidden" name="adultFl" value="y"> <input
															...
															<td>
																<div class="member_warning">
																	<input type="text" id="MEM_ID" name="MEM_ID"
																		style="width: 200px" value="${map.MEM_ID}" readonly>
																</div>
															</td>
															...
															<td class="member_password">
																<div class="member_warning">
																	<input type="password" id="MEM_PW" name="MEM_PW"
																		style="width: 200px" autocomplete="off" placeholder=""
																		value="${map.MEM_PW}">
																</div>
															</td>
														</tr>
															...
															<td>
																<div class="member_warning">
																	<input type="text" id="MEM_NAME" name="MEM_NAME"
																		style="width: 200px" data-pattern="gdMemberNmGlobal"
																		maxlength="30" value="${map.MEM_NAME}" readonly>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td class="member_address">
																<div class="address_postcode">
																	<input type="text" name="MEM_ZIPCODE" id="MEM_ZIPCODE"
																		style="width: 100px" value="${map.MEM_ZIPCODE}"
										...
										<div class="form-group" align="center">
											...
											<button type="button" class="btn btn-primary py-3 px-5"
												onClick="checks(this.form)">수정</button>

											&emsp;&emsp;
											<button type="button" class="btn btn-black py-3 px-5"
												onClick="return submit2(this.form);">탈퇴</button>

											&emsp;&emsp;
											<button type="button" class="btn btn-black py-3 px-5"
												onclick="changeForm(-1)">뒤로</button>
